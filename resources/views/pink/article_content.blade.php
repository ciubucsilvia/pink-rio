    ...
    @if($article)
        <div class="hentry hentry-post blog-big group ">
            ...
            <div class="thumbnail">
                ...
                <div class="image-wrap">
                    <img src="{{ asset(env('THEME')) }}/images/articles/00212-816x282.jpg" alt="00212" title="00212" />
                </div>
                <p class="date">
            ...
            <div class="meta group">
                ...
                <p class="comments"><span><a href="#comments" title="Comment on This is the title of the first article. Enjoy it.">{{ count($article->comments) ? count($article->comments) : 0 }} {{ Lang::choice('home.comments', count($article->comments)) }}</a></span></p>
            </div>
            <!-- post content -->
        ...
        <div id="comments">
            <h3 id="comments-title">
                <span>{{ count($article->comments) }}</span> {{ Lang::choice('home.comments', count($article->comments)) }}    
            </h3>
