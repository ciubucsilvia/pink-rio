                        ...
                        <div class="hentry work group portfolio-sticky portfolio-full-description">
                            <div class="work-thumbnail">
                                ...
                                <div class="work-overlay">
                                    <h3><a href="{{ route('portfoliosShow', ['alias' => $item->alias]) }}">{{ $item->title }}</a></h3>
                            ...
                            <div class="work-description">
                                <h2><a href="{{-- route('portfoliosShow', ['alias' => $item->alias]) --}}">{{ $item->title }}</a></h2>
                                <p class="work-categories">in: <a href="#">{{ $item->filter->title }}</a></p>
                                <p>{!! str_limit($item->text, 200) !!}</p>
                                <a href="{{ route('portfoliosShow', ['alias' => $item->alias]) }}" class="read-more">|| Read more</a>
                            </div>
                        </div>
                            ...
                            <div class="overlay_a related_img">
                                <div class="overlay_wrapper">
                                    ...
                                    <div class="overlay">
                                        ...
                                        <a class="overlay_project" href="{{ route('portfoliosShow', ['alias' => $item->alias]) }}"></a>
